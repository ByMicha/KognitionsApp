const translations = {
  de: {
    ...
    moca: {
      ...
      connectCircles: "Verbinden Sie die Kreise",
      setTheClock: "Stellen Sie die Uhrzeit auf",
      clock: "Uhr",
      hours: "Stunden",
      minutes: "Minuten",
      submitTime: "Uhrzeit einloggen",
      timeConfirmed: "Uhrzeit wurde bestätigt",
      pleaseNameAnimal: "Bitte benennen Sie das abgebildete Tier laut",
      listening: "Ich höre zu...",
      nextAnimal: "Nächstes Tier",
      endNaming: "Benennen abschließen",
      memoryInstructionListen: "Klicken Sie auf den Button, um die Wörter zu hören und prägen Sie sich diese ein." ,
      memoryInstructionName: "Sagen Sie nun alle Wörter laut auf, an die Sie sich noch erinnern können.",
      wordsAreRead: "Wörter werden vorgelesen...",
      listenToWordsNow: "Wörter jetzt anhören",
      goForNaming: "Weiter zum Aufsagen",
      recognitionRuns: "Erkennung läuft",
      stopReciting: "Aufsagen beenden",
      speakNow: "Sprechen Sie jetzt",
      listenNumberSequences: "Hören Sie die Zahlenreihe.",
      recallNumberSequenceForward: "Wiederholen Sie die Zahlen in der GLEICHEN Reihenfolge.",
      recallNumberSequenceBackwards: "Wiederholen Sie die Zahlen nun RÜCKWÄRTS.",
      numbersAreRead: "Zahlen werden vorgelesen...",
      numersListen: "Zahlen jetzt anhören",
      startTask: "Aufgabe starten",
      endTask: "Aufgabe beenden",
      nextStep: "Nächster Schritt",
      numbersForward: "Zahlen vorwärts",
      numbersBackwards: "Zahlen für rückwärts",
      pressThebuttonWhenLetter: "Tippen Sie auf den Button, wenn Sie den folgenden Buchstaben hören",
      listenCarefully: "Hören Sie gut zu...",
      done: "Abgeschlossen",
      pressCommand01: "Bei",
      pressCommand02: "pressen",
      thisIsACalculationExercise: "Dies ist eine Rechenaufgabe.",
      startWithNumber: "Beginnen Sie im Kopf bei der Zahl",
      andSubtractContinuely: "und ziehen Sie fortlaufend jeweils",
      calcExtendCommand: "ab",
      chooseCorrectForEachStep: "Wählen Sie für jeden Schritt das richtige Ergebnis aus den vier Möglichkeiten aus.",
      understoodStart: "Verstanden & Starten",
      taskDoneClickBelow: "Aufgabe abgeschlossen. Bitte unten klicken.",
      iWillReadYouASentence: "Ich werde Ihnen nun einen Satz vorlesen.",
      listenCarefullyAndRepeat: "Hören Sie aufmerksam zu und wiederholen Sie den Satz danach",
      exactly: "exakt",
      asIToldYou: "so, wie ich ihn gesagt habe.",
      listenToSentenceNow: "Satz jetzt hören",
      sayTheSentence: "Sagen Sie den Satz jetzt nach",
      yourAnswer: "Ihre Antwort",
      submitSolution: "Lösung abgeben",
      resultHasBeenSaved: "Das Ergebnis wurde gespeichert.",
      yourInput: "Ihre Eingabe",
      nameAsManyWords: "Nennen Sie in einer Minute so viele Wörter wie möglich mit dem gleich erscheinenden Buchstaben.",
      letsGo: "Starten",
      go: "LOS!",
      iDontKnowMore: "Ich weiß nicht mehr weiter",
      wordCheckWiktionary: "Wörter werden gegen Wiktionary geprüft...",
      validWords: "Gültige Wörter",
      wordsRecognized: "Erkannte Wörter im Detail",
      analysis: "Auswertung",
      wordsWith: "Wörter mit",
      ...
      tests: {
        ...
        naming: "Benennen",
        memoryImmediate: "Gedächtnis (Sofortiger Abruf)",
        attentionNumbers: "Aufmerksamkeit (Zahlenreihen)",
        attentionVigilance: "Aufmerksamkeit (Vigilanz)",
        attentionCalculation: "Aufmerksamkeit (Rechnen)",
        languageRepetition: "Sprache (Nachsprechen)",
        wordFluency: "Wortflüssigkeit",
        recall: "Verzögerter Abruf",
      }
    },
  ...
  en: {
    ...
    connectCircles: "Connect the circles",
    setTheClock: "Set the clock to",
    clock: "o'Clock",
    hours: "Hours",
    minutes: "Minutes",
    submitTime: "Submit time",
    timeConfirmed: "Time confirmed",
    pleaseNameAnimal: "Please name the pictured animal out loud",
    listening: "I am listening...",
    nextAnimal: "Next animal",
    endNaming: "Finish naming",
    memoryInstructionListen: "Click the button to hear the words and memorize them.",
    memoryInstructionName: "Now say all the words out loud that you can remember.",
    wordsAreRead: "Words are being read out loud...",
    listenToWordsNow: "Listen to the words now",
    goForNaming: "Continue to recall",
    recognitionRuns: "Recognition in progress",
    stopReciting: "Stop reciting",
    speakNow: "Speak now",
    listenNumberSequences: "Listen to the sequence of numbers.",
    recallNumberSequenceForward: "Repeat the numbers in the SAME order.",
    recallNumberSequenceBackwards: "Now repeat the numbers BACKWARDS.",
    numbersAreRead: "Numbers are being read out loud...",
    numersListen: "Listen to the numbers now",
    startTask: "Start task",
    endTask: "End task",
    nextStep: "Next step",
    numbersForward: "Digits forward",
    numbersBackwards: "Digits backward",
    pressThebuttonWhenLetter: "Tap the button when you hear the following letter",
    listenCarefully: "Listen carefully...",
    done: "Completed",
    pressCommand01: "Tap at",
    pressCommand02: "",
    thisIsACalculationExercise: "This is a calculation task.",
    startWithNumber: "Start in your head with the number",
    andSubtractContinuely: "and continuously subtract",
    calcExtendCommand: "",
    chooseCorrectForEachStep: "Choose the correct result from the four options for each step.",
    understoodStart: "Understood & Start",
    taskDoneClickBelow: "Task completed. Please click below.",
    iWillReadYouASentence: "I will now read a sentence to you.",
    listenCarefullyAndRepeat: "Listen carefully and repeat the sentence afterwards",
    exactly: "exactly",
    asIToldYou: "as I said it.",
    listenToSentenceNow: "Listen to the sentence now",
    sayTheSentence: "Repeat the sentence now",
    yourAnswer: "Your answer",
    submitSolution: "Submit solution",
    resultHasBeenSaved: "The result has been saved.",
    yourInput: "Your input",
    nameAsManyWords: "In one minute, name as many words as possible starting with the letter that is about to appear.",
    letsGo: "Start",
    go: "GO!",
    iDontKnowMore: "I don't know any more",
    wordCheckWiktionary: "Checking words against Wiktionary...",
    validWords: "Valid words",
    wordsRecognized: "Recognized words in detail",
    analysis: "Analysis",
    ...
    tests: {
      ...
      naming: "Naming",
      memoryImmediate: "Memory (Immediate Recall)",
      attentionNumbers: "Attention (Number Sequences)",
      attentionVigilance: "Attention (Vigilance)",
      attentionCalculation: "Attention (Calculation)",
      languageRepetition: "Language (Repetition)",
      wordFluency: "Word Fluency",
      recall: "Delayed Recall",
    }
  },
